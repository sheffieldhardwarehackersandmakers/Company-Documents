...
\title{Articles of Association of Sheffield Hardware Hackers and Makers CIC}

\begin{document}
\begin{titlepage}
\begin{center}
{\bf \LARGE Sheffield Hardware Hackers and Makers CIC}\\[36pt]
...
\item
  In the articles:
  \begin{description}
  \item[the association] means the above-named association.
...
\item
\label{itm:asset-caveats}
  Provided the conditions in Article  \ref{itm:full-consideration} are satisfied, Article  \ref{itm:assetlock} shall not apply to:
     \begin{enumerate} 
	 \item
   ...
   If:
	...
	\end{enumerate}
	\item
	  any residual assets shall be given or transferred to the asset-locked body specified in Article \ref{itm:asset-recipient} below. 
    \item
    \label{itm:asset-recipient}
      For the purposes of this asset lock, the following asset-locked body is specified as a potential recipient of the Company’s assets under Articles \ref{itm:asset-caveats} and \ref{itm:asset-insolvency}:
    \begin{description}
	  \item[Name] Access Space
	  \item[Charity Registration Number (if applicable)]  xxx
	  \item[Company Registration Number (if applicable)]  yyy
      \item[Registered Office]  zzz
    \end{description}
    \item
...
\item
  ...
  goals as outlined in the Community Interest Statement or is conducive or incidental to doing so. In
...
\item
  ...
  \item
    ...
    towards the goals outlined in the Statement of Community Interest.
  \item
    ...
    \item
      ...
      association, subject to approval by a majority of directors.
    \item
...
\item
  ...
  \item
    Such other persons as are admitted to membership in accordance with the Articles and relevant bye laws shall be members of the Company. 
  \item
  ...
  Membership is terminated if:
	...
	\item
	  the member resigns by written notice to the association unless, after the resignation, there would be fewer than three members;
  \item
  ...
  \item
    ...
    \item
	  ...
	  \end{enumerate}
  \item
    The directors must keep a register of names and contact information of the members, sufficient to enact these Articles and relevant bye laws.
  \end{enumerate}
  \end{enumerate}

\section{General Meetings}
\item \label{itm:general-meetings}
    General meetings will be held at a minimum of once every two calendar months.
\item
    Additionally, the Board may convene a General Meeting whenever they think fit. 
\item 
...
\item
    An Annual General Meeting shall be called within two weeks of the company's Accounting Reference Date. Its format and proceedings shall be the same as a General Meeting. Orders of business shall include
    \begin{enumerate}
    \item Presentation to the members and discussion of the preceding year's accounts and community interest report; and
    \item Announcement of results of the elections for new directors, and transfer of directors' positions from outgoing to incoming directors.
    \end{enumerate}
\item
	A person who is not a member of the Company shall not have any right to vote at a general meeting of the Company; but this is without prejudice to any right to vote on a resolution affecting the rights attached to a class of the Company’s debentures.
...
\item
  ...
  \item
    ...
    \begin{enumerate}
    \item
      one month for an annual general meeting, or fourteen clear days for a general meeting called for the passing of a special resolution;
    \item
...
\item
  ...
  \item
    ...
    special resolution.
  \item
    The quorum required for directors' meetings shall be three, or 50\% of the board, whichever is greater.
  \item
  \label{itm:directors-declaw}
    In the spirit of a community-run organisation, and subject to Article \ref{itm:directors-declaw-caveat} directors shall consult with the members on decisions, via a
  \begin{enumerate}
    \item
      General Meeting; or
    \item
      Mailing list published to all members' supplied email address, in which case, 
      \begin{enumerate}
      \item
        Directors shall be bound by the consensus, in their judgement, of the ensuing discussion; or
      \item
        At the request of members totalling at least 10\% of the membership, the decision may be postponed until it can be voted upon at a General Meeting.
      \end{enumerate}
  \end{enumerate}
  \label{itm:directors-declaw-caveat}
    \item
      In exception to Article \ref{itm:directors-declaw}, directors shall not be bound by any decision so made by Members which would otherwise lead the Company or its Directors into a breach of their legal obligations.
    \item
      In exception to Article \ref{itm:directors-declaw}, directors may occasionally choose to make certain decisions without members' input, in extraordinary circumstances such as
      \begin{enumerate}
        \item 
          Commercial sensitivity;
        \item
          A need to protect a member's or other individual's personal privacy;
        \item
          Dealing with an emergency situation;
        \item
          Being compelled to do so in order to meet legal obligations.
       \end{enumerate}
     \item In cases where directors have made decisions without consulting members, directors shall inform members of 
       \begin{enumerate}
       \item
       the nature of the decision being undertaken;
       \item
       the reason(s) for a decision being made without consulting the members; and
       \item
       as much information regarding the decision as can reasonably be shared.
       \end{enumerate}       
  \item
...
\item
  \begin{enumerate}
    \item The directors elections shall be timed to coincide with the Annual General Meeting.
    \item Directors shall announce the elections to all members, at least four weeks before the Annual General Meeting. This announcement shall include a list of directors who are stepping down, and the number of posts to be filled.
    \item Following this announcement, members and retiring directors who wish to stand for election must publicly nominate themselves at least two weeks before the Annual General Meeting.
    \item Two weeks before the Annual General Meeting, directors will publish a list of the candidates standing for election and open the poll.
    \item
      The directors election must be carried out by electronically polling the membership as follows:
      \begin{enumerate}
        \item An STV voting method with a "no further places" candidate must be used.
        \item All members of the association at the time the election commences are eligible to vote.
        \item The quorum of the election is 10\% of eligible voters.
      \end{enumerate}
    \item The election will end one day before the Annual General Meeting.
    \item The election results will be announced at the Annual General Meeting.
    \item Upon announcement of election results, retiring directors who were not re-elected shall immediately step down, and members who were elected shall immediately become directors.
     \end{enumerate}
    \item Changes to the size of the board may be achieved by managing the number of "director" posts available to be filled at a given election. However:
      \begin{enumerate}
      \item
        Any changes in the size of the board must be proposed by the directors and approved by a poll of the members at least one month before the election; and
      \item
        In an election in which the size of the board is changing, the number of directors required to step down as outlined in Article \ref{itm:director-retirement} shall be based on the size of the board before the election, and not influenced by the number of posts to be filled.
    \end{enumerate}
...
\item
    \begin{enumerate}
        \item \label{itm:director-retirement} A director must retire at or before the second Annual General Meeting after the one in which they were appointed.
        \item If a director was appointed other than at an Annual General Meeting, they must retire at the first Annual General Meeting during their service.
        \item A director who is due to retire at a given Annual General Meeting may nominate themself for re-election and, if re-elected, continue in their post without interruption.
    \end{enumerate}
...
\item \label{director-cease}
  ...
  \begin{enumerate}
    ...
    least three directors will remain in office when the notice of
...
\item
  \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item
        by a written resolution in accordance with the procedure described in  Article \ref{itm:written-resolution} below.
    \end{enumerate}
    \item
...
\item  \label{itm:written-resolution}
...
\item
  ...
  \item \label{dissolve-transfer}
    ...
    following ways, subject to the requirements of the Asset Lock outlined in these Articles
    \begin{enumerate}
    \item
      directly for the purpose outlined in the Community Interest Statement; or
    \item
      by transfer to a registered charity, CIC or other suitable association for purposes similar to those in the
      Community Interest Statement.
    \end{enumerate}
  \item 
    The directors of the association may at any time before, and in
    expectation of, its dissolution resolve that any net assets of the
    association after all its debts and liabilities have been paid, or
    provision has been made for them, shall on or before the
    dissolution of the association be applied or transferred in any of the
